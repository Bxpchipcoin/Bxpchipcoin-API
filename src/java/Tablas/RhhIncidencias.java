...
public class RhhIncidencias extends TableMaster {
    ...
    private ArrayList<RhhPrimaDominical> listDomingos;
    private ArrayList<RhhDiasFestivos> listDiasFestivos;
    ...
    public ArrayList<RhhPrimaDominical> getListDomingos() {
        if (listDomingos == null) {
            listDomingos = new ArrayList<RhhPrimaDominical>();
        }
        return listDomingos;
    }

    public void setListDomingos(ArrayList<RhhPrimaDominical> listDomingos) {
        this.listDomingos = listDomingos;
    }

    public ArrayList<RhhDiasFestivos> getListDiasFestivos() {
        if (listDiasFestivos == null) {
            listDiasFestivos = new ArrayList<RhhDiasFestivos>();
        }
        return listDiasFestivos;
    }

    public void setListDiasFestivos(ArrayList<RhhDiasFestivos> listDiasFestivos) {
