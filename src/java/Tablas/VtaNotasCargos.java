...
/**
 *Representa el cabecero de la tabla de notas de cargo
 * @author ZeusSIWEB
 */
public class VtaNotasCargos extends TableMaster {

   public VtaNotasCargos() {
      super("vta_notas_cargos", "NCA_ID", "", "");
      ...
      this.Fields.put("NCA_RETISR",0);
      this.Fields.put("NCA_RETIVA",0);
      this.Fields.put("NCA_NETO",0);
