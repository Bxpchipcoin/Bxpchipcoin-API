...
/**
 *Representa el detalle de las notas de cargo
 * @author ZeusSIWEB
 */
public class VtaNotasCargosProvDeta extends TableMaster {

   // <editor-fold defaultstate="collapsed" desc="Propiedades">
   // </editor-fold>
   // <editor-fold defaultstate="collapsed" desc="Constructores">
   public VtaNotasCargosProvDeta() {
      super("vta_notas_cargosprovdeta", "NCAD_ID", "", "");
