...
public class rhh_nominas extends TableMaster {
   ...
   public rhh_nominas() {
      ...
      //VERSION 1.2
      this.Fields.put("NOM_RFCPATROORIGEN", "");
      this.Fields.put("NOM_ORIGENRECURSO", "");
      this.Fields.put("NOM_MONTORECURSOPROPIO", 0.0);
      this.Fields.put("NOM_VALORMERCADO", 0.0);
      this.Fields.put("NOM_PRECIOALOTORGARSE", 0.0);
      this.Fields.put("NOM_TOTALUNAEXHIBICION", 0.0);
      this.Fields.put("NOM_TOTALPARCIALIDAD", 0.0);
      this.Fields.put("NOM_MONTODIARIO", 0.0);
      this.Fields.put("NOM_INGRESOACUMULABLE", 0.0);
      this.Fields.put("NOM_INGRESONOACUMULABLE", 0.0);
      this.Fields.put("NOM_TOTALPAGADO", 0.0);
      this.Fields.put("NOM_NUMANIOSSERVICIO", 0);
      this.Fields.put("NOM_ULTIMOSUELDOMENSORD", 0.0);
      this.Fields.put("NOM_INGRESOACUMULABLE_SEP", 0.0);
      this.Fields.put("NOM_INGRESONOACUMULABLE_SEP", 0.0);
