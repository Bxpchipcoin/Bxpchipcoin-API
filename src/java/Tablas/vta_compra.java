...
public class vta_compra extends TableMaster {
    ...
    public vta_compra() {
        ...
        this.Fields.put("STR_ID", new Integer(0));
        this.Fields.put("COM_NUM_GUIA", "");
        this.Fields.put("PV_CONSIGNAR", new Integer(0));
        this.Fields.put("PV_NOTIFICAR", new Integer(0));
        this.Fields.put("PV_AG_ADUANAL", new Integer(0));
        this.Fields.put("COM_EXTERNO", new Integer(0));
        this.Fields.put("SC_ID_EXTERNO", new Integer(0));
        this.Fields.put("EMP_ID_EXTERNO", new Integer(0));
        this.Fields.put("COM_ID_ORIG_EXTERNO", new Integer(0));
    }
}