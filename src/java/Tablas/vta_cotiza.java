...
public class vta_cotiza extends TableMaster {
   ...
   public vta_cotiza() {
      ...
      this.Fields.put("COT_CONTRATO", "");
      this.Fields.put("COT_SOLICITANTE", "");
      this.Fields.put("COT_COT_ORIG", "");
      this.Fields.put("COT_MOTIVO_ANUL", new Integer(0));
      this.Fields.put("COT_OC_CLIENTE", "");
      this.Fields.put("COT_IMPR_CLI_ID", new Integer(0));
      this.Fields.put("COT_IMPR_FECHA", "");
      this.Fields.put("COT_IMPR_HORA", "");
      this.Fields.put("COT_IMPR_NUMERO", new Integer(0));
      this.Fields.put("COT_BOD_SOLICITANTE", "");
      this.Fields.put("COT_SUC_INT", "");
      this.Fields.put("COT_BOD_INT", "");
      this.Fields.put("COT_SUC_SOLICITANTE", "");
      this.Fields.put("COT_NOTAS_INGR", "");
      this.Fields.put("COT_FECHA_SURTIDO", "");
      this.Fields.put("COT_FECHA_ENTREGA", "");
      this.Fields.put("COT_ORDEN_COMPRA", "");
      this.Fields.put("COT_TIPO_PEDIDO", new Integer(0));
      this.Fields.put("COT_IMPRESO", new Integer(0));
      this.Fields.put("COT_TRANSFERENCIA", new Integer(0));
      this.Fields.put("COT_PEDMANUAL", "");
      this.Fields.put("COT_STATUS", new Integer(0));
      this.Fields.put("COT_FECHA_VALIDEZ", "");
      this.Fields.put("COT_IDMOTIVO", new Integer(0));
      this.Fields.put("COT_IDDESC", "");
      this.Fields.put("COT_US_MOD", new Integer(0));            
        this.Fields.put("COT_TIENE_FLETE", new Integer(0));
        this.Fields.put("COT_TIENE_SEGURO", new Integer(0));
        this.Fields.put("COT_MONTO_SEGURO", new Double(0));
