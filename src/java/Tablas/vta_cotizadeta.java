...
public class vta_cotizadeta extends TableMaster {
   ...
   public vta_cotizadeta() {
      ...
      this.Fields.put("COTD_CANT_REQU", new Integer(0));
      this.Fields.put("COTD_BACKORDER", "");
      this.Fields.put("COTD_CANTTRANS", new Integer(0));
      this.Fields.put("COTD_CANT_RECI", new Integer(0));
      this.Fields.put("COTD_CANT_RECI_CONF", new Integer(0));
      this.Fields.put("COTD_ES_PAQUETE", new Integer(0));
      this.Fields.put("COTD_ES_COMPONENTE", new Integer(0));
      this.Fields.put("COTD_PR_PAQUETE", new Integer(0));
      this.Fields.put("COTD_MULTIPLO", new Integer(0));
        this.Fields.put("COTD_CANTIDAD_IMPRIMIR", new Integer(0));
        this.Fields.put("COTD_ES_VIRTUAL", new Integer(0));
        this.Fields.put("COTD_CANT_MULTIPLOS", new Integer(0));
        this.Fields.put("COTD_PRECIO_MULTIPLO", new Double(0));
        this.Fields.put("COTD_CANT_CORTESIAS", new Integer(0));
        this.Fields.put("COTD_CANTTOT_BACKORDER", new Double(0));
        this.Fields.put("COTD_PRECIOSOLIC", new Double(0));  
   }
}
