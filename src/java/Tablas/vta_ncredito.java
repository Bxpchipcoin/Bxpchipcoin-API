 ...
 * @author zeus
 */
public class vta_ncredito extends TableMaster {

   /**
    * Constructor
    */
   public vta_ncredito() {
      super("vta_ncredito", "NC_ID", "", "");
      ...
      this.Fields.put("NC_ES_CFD", new Integer(0));
      this.Fields.put("NC_ES_CBB", new Integer(0));
      this.Fields.put("NC_ES_DEVO", new Integer(0));
   }
}
