...
public class vta_pedidos extends TableMaster {
    ...
    public vta_pedidos() {
        ...
        this.Fields.put("PD_FECHA_ENTREGA", "");
        this.Fields.put("PD_FECHA_SURTIDO", "");
        this.Fields.put("PD_PEDMANUAL", "");
        this.Fields.put("PD_CONTRATO", "");
        this.Fields.put("PD_COT_ORIG", "");
        this.Fields.put("PD_OC_CLIENTE", "");
        this.Fields.put("PD_IMPRESO", new Integer(0));
        this.Fields.put("PD_TRANSFERENCIA", new Integer(0));
        this.Fields.put("PD_PEDMANUAL", "");
        this.Fields.put("PD_CONTRATO", "");
        this.Fields.put("PD_SOLICITANTE", "");
        this.Fields.put("PD_COT_ORIG", "");
        this.Fields.put("PD_MOTIVO_ANUL", new Integer(0));
        this.Fields.put("PD_OC_CLIENTE", "");
        this.Fields.put("PD_IMPR_CLI_ID", new Integer(0));
        this.Fields.put("PD_IMPR_FECHA", "");
        this.Fields.put("PD_IMPR_HORA", "");
        this.Fields.put("PD_IMPR_NUMERO", new Integer(0));
        this.Fields.put("PD_BOD_SOLICITANTE", "");
        this.Fields.put("PD_SUC_INT", "");
        this.Fields.put("PD_BOD_INT", "");
        this.Fields.put("PD_SUC_SOLICITANTE", "");
        this.Fields.put("PD_NOTAS_INGR", "");
        this.Fields.put("PD_TIENE_FLETE", new Integer(0));
        this.Fields.put("PD_TIENE_SEGURO", new Integer(0));
        this.Fields.put("PD_MONTO_SEGURO", new Double(0));
        this.Fields.put("PD_SE_FACTURA_LOGISTICA", new Integer(0));
        this.Fields.put("PD_SE_FACTURA_PEDIDO", new Integer(0));
        this.Fields.put("PD_TIPO_PEDIDO", new Integer(0));
        this.Fields.put("PD_CONCENTRADORA", new Integer(0));
        this.Fields.put("PD_SC_CONCENTRADORA", new Integer(0));
