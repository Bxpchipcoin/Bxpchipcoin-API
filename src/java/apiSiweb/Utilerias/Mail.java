...
//               guardarMsg(sesion, msg);
   ...
   private void guardarMsg(javax.mail.Session sesion, Message msg) {
//      try {
         //Guardar mensajes
//         Store store = sesion.getStore("imap");
//         store.connect(this.host, usuario, this.contrasenia);
...
//
//         //Folder folder = store.getFolder("INBOX");
////         //Validamos si existe el folder sino lo creamos
////         if (!folder.exists()) {
