...
public class MonedasTrading {
    ...
    public MonedasTrading(Conexion oConn) {
        this.oConn = oConn;
    ...
    public double GetFactorConversionParidad(String strFecha, int intTipoConversion, int intMonedaBase, int intMonedaFinal) {
        ...
        strSql.append("(TC_MONEDA1 = ").append(intMonedaFinalD).append(" and TC_MONEDA2=").append(intMonedaBase);
        ...
        if (dblFactorDolar != 0 && intMonedaFinal != 2) {
            ...
            strSql.append("(TC_MONEDA1 = ").append(intMonedaFinal).append(" and TC_MONEDA2=").append(intMonedaFinalD);
            strSql.append(")) order by TC_FECHA DESC limit 0,1");
            try {
                ResultSet rs = this.oConn.runQuery(strSql.toString(), true);
                while (rs.next()) {
        ...
        dblFactor = (1*dblFactorDolar) / (1*dblFactorMoneda);
        return dblFactor;
    }
    ...
    public double GetFactorConversionParidadDolar(String strFecha, int intTipoConversion, int intMonedaFinal) {
        ...
        strSqld.append("(TC_MONEDA1 = ").append(intMonedaFinal).append(" and TC_MONEDA2=").append(intMonedaBase);
